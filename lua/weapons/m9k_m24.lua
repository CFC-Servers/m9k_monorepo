...
SWEP.Primary.Sound            = "Dmgfok_M24SN.Single"        -- script that calls the primary fire sound
...
SWEP.Primary.SpreadIronSights = .000115 -- ironsight accuracy, should be the same for shotguns
