...
SWEP.VElements = {
    ["nerve"] = { type = "Model", model = "models/healthvial.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector( -0.076, 0.24, 0.063 ), angle = Angle( -17.351, -8.782, -99.302 ), size =
        Vector( 0.54, 0.54, 0.54 ), color = Color( 255, 255, 255, 255 ), surpresslightning = false, material = "models/weapons/gv/nerve_vial.vmt", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
    ["nerveagent"] = { type = "Model", model = "models/healthvial.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector( 3.22, 2.107, -4.025 ), angle = Angle( 0, 0, 0 ), size = Vector( 0.865,
        0.865, 0.865 ), color = Color( 255, 255, 255, 255 ), surpresslightning = false, material = "models/weapons/gv/nerve_vial.vmt", skin = 0, bodygroup = {} }
}
