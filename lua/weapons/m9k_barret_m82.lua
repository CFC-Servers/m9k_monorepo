...
SWEP.Primary.Sound            = "BarretM82.Single" -- script that calls the primary fire sound
...
SWEP.Primary.SpreadIronSights     = .00001 -- ironsight accuracy, should be the same for shotguns
