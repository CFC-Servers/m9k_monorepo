...
SWEP.Primary.Sound            = "Weapon_svd01.Single" -- script that calls the primary fire sound
...
SWEP.Primary.SpreadIronSights     = .00012 -- ironsight accuracy, should be the same for shotguns
