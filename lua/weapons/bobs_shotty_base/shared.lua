...
function SWEP:InsertShell()
    ...
    if owner:Alive() then
        ...
        local ammoCount = owner:GetAmmoCount( self.Primary.Ammo )
        local clip = self:Clip1()

        if clip >= self.Primary.ClipSize or ammoCount <= 0 then
