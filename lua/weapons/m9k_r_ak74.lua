...
SWEP.Gun = "m9k_r_ak74" -- must be the name of your swep but NO CAPITALS!

SWEP.UseHands = true

SWEP.Category                = "M9K Assault Rifles - CHands"
SWEP.Author                = "reshed0311"
SWEP.Contact                = ""
SWEP.Purpose                = ""
SWEP.Instructions                = ""
...
SWEP.ViewModel                = "models/weapons/m9k_rifles/m9k_r_ak74.mdl"    -- Weapon view model
...
SWEP.Primary.Sound            = "r_ak74.single"        -- Script that calls the primary fire sound
