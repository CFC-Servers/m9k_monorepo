...
self:SetNWBool("smoke", true)
 ...
 function ENT:Think()
	...
	self.flightvector = self.flightvector - self.flightvector/((147*39.37)/66) + self:GetForward()*2 + Vector(math.Rand(-0.3,0.3), math.Rand(-0.3,0.3),math.Rand(-0.1,0.1)) + Vector(0,0,-0.111)
